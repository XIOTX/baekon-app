  ...
  return (
    <div className="h-full w-full p-2">
      ...
      >
        ...
        >
          {/* Fallback background using img element if CSS background fails */}
          <img
        ...
        {/* Main Visual Area - Square Image Box */}
        <div
          className="absolute top-7 left-7 rounded-lg border cursor-pointer hover:opacity-90 transition-opacity grid-bg"
          style={{
            width: 'calc(100% - 56px)',
            aspectRatio: '1',
            boxShadow: '0px 0px 37px -10px #C080FF inset',
