        ...
        <div className="w-full flex items-center">
          <div className="flex w-full space-x-2">
            ...
            <div className="flex-1 relative">
              ...
              {activeSection === 'work' && (
                <div className="absolute top-full left-0 right-0 mt-1 flex rounded-sm overflow-hidden border-b border-l border-r">
                  <button
                    onClick={() => setWorkView('box')}
                    className={`flex-1 px-2 py-0.5 text-xs rounded-bl border-t border-l transition-all duration-200 ${
                      workView === 'box'
                        ? 'border-neon-blue text-neon-blue bg-black bg-opacity-60'
                        : 'border-gray-600 text-gray-400 hover:border-neon-blue hover:text-neon-blue bg-black bg-opacity-40'
                    }`}
                  ...
                  <button
                    ...
                    className={`flex-1 px-2 py-0.5 text-xs rounded-br border-t border-r transition-all duration-200 ${
                      workView === 'board'
                        ? 'border-neon-blue text-neon-blue bg-black bg-opacity-60'
                        : 'border-gray-600 text-gray-400 hover:border-neon-blue hover:text-neon-blue bg-black bg-opacity-40'
                    }`}
