...
export default function MainPanel({
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case 'work':
        return <WorkView userId={userId} activeView={workView} setActiveView={setWorkView} />;
      case 'life':
        return <LifeView userId={userId} activeView={lifeView} setActiveView={setLifeView} />;
      default:
        return null;
    }
  };
